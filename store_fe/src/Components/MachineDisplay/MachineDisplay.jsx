       ...
       <div className="productdisplay">
            <div className="productdisplay-left">
                <div className="productdisplay-img-list">
                    <img src={machine.image} alt="" style={{width: '30vw'}}/>
                </div>
                <div className="productdisplay-img">
                    <img src={machine.image} alt="" className="productdisplay-main-img" />
                </div>
            </div>
            <div className="productdisplay-right">
                <h1>{machine.name}</h1>
                <div className="productdisplay-right-prices">
                    <div className="productdisplay-right-price-old">${machine.old_price}</div>
                    <div className="productdisplay-right-price-new">${machine.new_price}</div>
                </div>
